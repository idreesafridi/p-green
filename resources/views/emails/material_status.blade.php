                ...
                <td>
                            ...
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #0a6e33; color: #000000; width: 430px; margin: 0 auto;"
                                        width="430">
                                        <tbody>
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <div style="max-width: 160px;"><img
                                                                            src="{{ asset('assets/images/email/GREENGEN-REBRAND-VERDE-183X103_300_x_103_px_1.png') }}"
                                                                ...
                                                                {{-- <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            {{ $user }} ha modificato i materiali sul cantiere<br /><br /></p>
                                                                    </div>
                                                                </div> --}}
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td class="pad">
                                                                {{-- <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                                                        <p
                                                                            style="margin: 0; font-size: 22px; text-align: center; mso-line-height-alt: 16.8px;">
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-3"
                        ...
                        <tbody>
                            <tr>
                                <td align="center">
                                    <div class="ultra_main" style="margin: 0 auto; padding-bottom: 20px;">
                                        <div class="ultra-main1" style="width: 430px; ">
                                            <div class="main">
                                                <p
                                                style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;">
                                                {{ $msg }}
                    ...
                    <table border="0" cellpadding="0" cellspacing="0"
                    class="button_block block-9" role="presentation"
                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                    width="100%">
                    <tr>
                        <td class="pad" style="text-align:center; ">
                            <div align="center" class="alignment" style="margin: 0 auto; padding-bottom: 10px;"><!--[if mso]>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:60px;width:210px;v-text-anchor:middle;" arcsize="7%" stroke="false" fillcolor="#076c32">
<w:anchorlock/>
<v:textbox inset="0px,0px,0px,0px">
<center style="color:#ffffff; font-family:Arial, sans-serif; font-size:21px">
<![endif]-->
{{-- commeted data  --}}
@if($construction_id != null)
<a class="custom-button"
href="{!! Route('emailalert', $construction_id) !!}">
<span
style="word-break: break-word;">VAI
AL CANTIERE</span>
</a>
@endif
                        </td>
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;">
                                                                            Greengen Group S.R.L. 080.9.48.66.48</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
