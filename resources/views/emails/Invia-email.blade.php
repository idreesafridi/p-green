                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <strong>{{$subject}}</strong><br /></p>
                                                                                <p
                                                                            style="margin: 0; font-size: 18px; text-align: center; mso-line-height-alt: 16.8px;">
                                                                            <strong>{{$user != null ? 'Email da'. $user : ''}}</strong><br /><br /></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <p
                                                                            style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;">
                                                                            !!! Non rispondere a questa email ma contatta<br />  {{$userEmail != null ?  '<'. $userEmail . '>' : ''}} <br /><br /></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
