                        ...
                        <table class="table document-table table-hover ">
                            ...
                            <tbody>
                                @foreach ($prenoti_doc['prenoti_doc']->PrNotDoc as $prnotdoc)
                                    @if ($prnotdoc->state == 1)
                                        @if ($prnotdoc->folder_name == 'Altri Documenti Interni')
                                            <tr>
                                                <td>
                                ...
                                @foreach ($prenoti_doc['prenoti_and_relif']->unique('folder_name') as $reliefdocument)
                                    @if ($reliefdocument->state == 1)
                                        @if ($reliefdocument->folder_name == 'Diagnosi Energetica' || $reliefdocument->folder_name == 'Schemi Impianti' || $reliefdocument->folder_name == 'Documenti Clienti' || $reliefdocument->folder_name == 'Documenti Fotovoltaico' || $reliefdocument->folder_name == 'Documenti Co-intestatari' || $reliefdocument->folder_name == 'Pratiche Comunali' || $reliefdocument->folder_name == 'Documenti Libretto Impianti' || $reliefdocument->folder_name == 'Documenti Rilievo' || $reliefdocument->folder_name == 'Documenti Fine Lavori')
                                            <tr>
                                                <td>
