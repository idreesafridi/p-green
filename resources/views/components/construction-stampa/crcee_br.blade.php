<div class="crcee_le">
    <div class="container3">
        <img src="{{ asset('assets/stampa/RCEE/br_5.png') }}" id="ci4" style="height: 1200px;width: 800px;position: absolute;top: -3rem;">
        <img src="{{ asset('assets/stampa/RCEE/br_6.png') }}" id="ci5" style="height: 1200px;width: 800px;position: absolute;top: 73rem;">
        <img src="{{ asset('assets/stampa/RCEE/br_7.png') }}" id="ci6" style="height: 1200px;width: 800px;position: absolute;top: 146rem;">
        <img src="{{ asset('assets/stampa/RCEE/br_8.png') }}" id="ci7"
            style="height: 1200px;width: 800px;position: absolute;top: 219rem;">
        <img src="{{ asset('assets/stampa/RCEE/br_9.png') }}" id="ci8"
            style="height: 1200px;width: 800px;position: absolute;top: 292rem;">
        <img src="{{ asset('assets/stampa/RCEE/br_10.png') }}" id="ci9"
    ...
    <div class="correzione" style="position: absolute; top: 439rem;">
        <div class="container">
            <img src="{{ asset('assets/stampa/RCEE/br_1.png') }}" id="ci"
        ...
        <div class="container2" style="position: relative;top: 70rem;">
            <img src="{{ asset('assets/stampa/RCEE/br_2.png') }}" id="ci2"
        ...
        <div class="container3">
            <img src="{{ asset('assets/stampa/RCEE/br_3.png') }}" id="ci3"
        ...
        <div class="container3">
            <img src="{{ asset('assets/stampa/RCEE/br_4.png') }}" id="ci4"
