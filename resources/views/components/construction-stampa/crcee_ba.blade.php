<div class="crcee_le" style="position: relative;"> 
    <div class="container3" >
        <img src="{{ asset('assets/stampa/RCEE/ba_5.png') }}" id="ci4" style="height: 1200px;width: 800px;position: absolute;top: -4.5rem;">
        <img src="{{ asset('assets/stampa/RCEE/ba_6.png') }}" style="height: 1200px;width: 800px;position: absolute;top: 74.3rem;">
        <img src="{{ asset('assets/stampa/RCEE/ba_7.png') }}" style="height: 1200px;width: 800px;position: absolute;top: 145.8rem;">
        <img src="{{ asset('assets/stampa/RCEE/ba_8.png') }}" style="height: 1200px;width: 800px;position: absolute;top: 219rem;">
        <img src="{{ asset('assets/stampa/RCEE/ba_9.png') }}" id="ci8" style="height: 1200px;width: 800px;position: absolute;top: 292rem;">
        <img src="{{ asset('assets/stampa/RCEE/ba_10.png') }}" id="ci9" style="height: 1200px;width: 800px;position: absolute;top: 365rem;">
        ...
        <div id=tel6 style="margin-top: 40px;">{{ $construction->DocumentAndContact == null ? '' : $construction->DocumentAndContact->contact_number  }}</div>
    ...
    <div class="correzione" style="position: absolute; top: 439rem;">
        <div class="container" style="">
            <img src="{{ asset('assets/stampa/RCEE/ba_1.png') }}" id="ci"
        ...
        <div class="container2" style="position: relative;top: 70rem;">
            <img src="{{ asset('assets/stampa/RCEE/ba_2.png') }}" id="ci2"
                style="height: 1200px;width: 800px;position: absolute;top: 74.4rem;">
            <div id=comImm2 style="width:max-content">{{ $construction->residence_common }}</div>
            <div id=provImm2 style="margin-left:30px; width:max-content">{{ $construction->PropertyData == null ? '' : $construction->PropertyData->property_province }}</div>
        ...
        <div class="container3">
            <img src="{{ asset('assets/stampa/RCEE/ba_3.png') }}" id="ci3"
                style="height: 1200px;width: 800px;position: absolute;top: 288rem;">
            <div id=comImm3 style="margin-top: -130px; width:max-content">{{ $construction->residence_common }}</div>
            <div id=provImm3 style="margin-top: -130px; margin-left:30px; width:max-content">{{ $construction->PropertyData == null ? '' : $construction->PropertyData->property_province }}</div>
            <div id=viaImm3 style="margin-top: -130px; width:max-content">{{ $construction->PropertyData == null ? '' : $construction->PropertyData->property_street }}</div>
            <div id=nImm3 style="margin-top: -130px; width:max-content">{{ $construction->PropertyData == null ? '' : $construction->PropertyData->property_house_number }}</div>
            <div id=cognome3 style="margin-top: -130px; width:max-content">{{ $construction->surename }}</div>
            <div id=nome3 style="margin-top: -130px; width:max-content">{{ $construction->name }}</div>
            <div id=cf3 style="margin-top: -130px; margin-left:30px; width:max-content">{{ $construction->DocumentAndContact == null ? '' : $construction->DocumentAndContact->fiscal_document_number }}</div>

        </div>
        <div class="container3">
            <img src="{{ asset('assets/stampa/RCEE/ba_4.png') }}" id="ci4"
                style="height: 1200px;width: 800px;position: absolute;top: 363rem;">
            <div id=comImm44  style="margin-top: -30px; width:max-content">{{ $construction->residence_common }}</div>
            <div id=provImm44 style="margin-top: -30px; width:max-content">{{ $construction->PropertyData == null ? '' : $construction->PropertyData->property_province }}</div>
            <div id=viaImm44 style="margin-top: -30px; width:max-content">{{ $construction->PropertyData == null ? '' : $construction->PropertyData->property_street }}</div>
            <div id=nImm44 style="margin-top: -30px; width:max-content">{{ $construction->PropertyData == null ? '' : $construction->PropertyData->property_house_number }}</div>
            <div id=cognome44 style="margin-top: -30px; width:max-content">{{ $construction->surename }}</div>
            <div id=nome44 style="margin-top: -30px; width:max-content">{{ $construction->name }}</div>
            <div id=cf44 style="margin-top: -30px; width:max-content">{{ $construction->DocumentAndContact == null ? '' : $construction->DocumentAndContact->fiscal_document_number }}</div>
        </div>
    </div>
</div>
