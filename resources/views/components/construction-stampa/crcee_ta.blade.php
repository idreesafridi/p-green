<div class="crcee_le">
    ...
    <div class="container3">
        <img src="{{ asset('assets/stampa/RCEE/ta_5.png') }}" id="ci4" style="height: 1200px;width: 800px;position: absolute;top: -4.7rem;">
        <img src="{{ asset('assets/stampa/RCEE/ta_6.png') }}" id="ci5" style="height: 1200px;width: 800px;position: absolute;top: 72.9rem;">
        <img src="{{ asset('assets/stampa/RCEE/ta_7.png') }}" id="ci6" style="height: 1200px;width: 800px;position: absolute;top: 147rem;">
        <img src="{{ asset('assets/stampa/RCEE/ta_8.png') }}" id="ci7"
            style="height: 1200px;width: 800px;position: absolute;top: 220.9rem;">
        <img src="{{ asset('assets/stampa/RCEE/ta_9.png') }}" id="ci8"
            style="height: 1200px;width: 800px;position: absolute;top: 292rem;">
        <img src="{{ asset('assets/stampa/RCEE/ta_10.png') }}" id="ci9"
        ...
        <div id=cf4 style="margin-top: 10px">{{ $construction->DocumentAndContact == null ? '' : $construction->DocumentAndContact->fiscal_document_number }}</div>
        ...
        <div id=tel6 style="margin-top: 14px;">{{ $construction->DocumentAndContact == null ? '' : $construction->DocumentAndContact->contact_number  }}</div>
    ...
    <div class="correzione" style="position: absolute; top: 430rem;">
        <div class="container">
            <img src="{{ asset('assets/stampa/RCEE/ta_1.png') }}" id="ci"
        ...
        <div class="container2" style="position: relative;top: 70rem;">
            <img src="{{ asset('assets/stampa/RCEE/ta_2.png') }}" id="ci2"
        ...
        <div class="container3">
            <img src="{{ asset('assets/stampa/RCEE/ta_3.png') }}" id="ci3"
        ...
        <div class="container3">
            <img src="{{ asset('assets/stampa/RCEE/ta_4.png') }}" id="ci4"
