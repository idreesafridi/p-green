<div class="c65">
    <div class="container1" style="position: relative;">
        <img src="{{ asset('assets/stampa/65/1.png') }}" style="height: 1162px;width: 800px;position: relative;">
    ...
    <div class="container2" style="position: relative;">
        <img src="{{ asset('assets/stampa/65/2.png') }}" style="height: 1162px;width: 800px;position: relative;">
        <div class="comuneImm">
            {{ $construction->PropertyData == null ? '' : $construction->PropertyData->property_common }}</div>
        <div class="provinciaImm">
            {{ $construction->PropertyData == null ? '' : $construction->PropertyData->property_province }}</div>
    ...
    <div class="container3" style="position: relative;">
        <img src="{{ asset('assets/stampa/65/3.png') }}" style="height: 1162px;width: 800px;position: relative;">
    </div>
    <div class="container4" style="position: relative;">
        <img src="{{ asset('assets/stampa/65/4.png') }}" style="height: 1162px;width: 800px;position: relative;">
    </div>
    <div class="container5" style="position: relative;">
        <img src="{{ asset('assets/stampa/65/5.png') }}" style="height: 1162px;width: 800px;position: relative;">
    </div>
    <div class="container6" style="position: relative;">
        <img src="{{ asset('assets/stampa/65/6.png') }}" style="height: 1162px;width: 800px;position: relative;">
    </div>
    <div class="container7" style="position: relative;">
        <img src="{{ asset('assets/stampa/65/7.png') }}" style="height: 1162px;width: 800px;position: relative;">
    </div>
    <div class="container8" style="position: relative;">
        <img src="{{ asset('assets/stampa/65/8.png') }}" style="height: 1162px;width: 800px;position: relative;">
    </div>
    <div class="container9" style="position: relative;">
        <img src="{{ asset('assets/stampa/65/9.png') }}" style="height: 1162px;width: 800px;position: relative;">
        <div class="committente">{{ $construction->name }} {{ $construction->surename }}</div>
        <div class="dataNascita">
            @if ($construction->date_of_birth != null)
                {{ \Carbon\Carbon::parse($construction->date_of_birth)->format('d/m/Y') }}
    ...
    <div class="container10" style="position: relative;">
        <img src="{{ asset('assets/stampa/65/10.png') }}" style="height: 1162px;width: 800px;position: relative;">
        <div class="committente">{{ $construction->name }} {{ $construction->surename }}</div>
        <div class="cf">
            {{ $construction->DocumentAndContact == null ? '' : $construction->DocumentAndContact->fiscal_document_number }}
        </div>
