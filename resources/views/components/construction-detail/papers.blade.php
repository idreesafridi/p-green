<div class="card-head document-page-header py-4" id="paper">
    <div class="d-flex align-items-center">
        <i class="fa fa-arrow-left me-3 back"></i>
        <h6 class="heading fw-bold mb-0">Documenti</h6>
    </div>
    <form>
        <div class="row">
            ...
            <div class="col-12 col-lg-8 mt-4 d-md-flex justify-content-between align-items-center">
                <div>
                    ...
                    <nav class="d-inline-block filterList hideInMobile hideInTablet">
