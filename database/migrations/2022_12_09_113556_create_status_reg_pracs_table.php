...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('status_reg_pracs', function (Blueprint $table) {
            ...
            $table->string('reminders_emails')->default(10);
            $table->string('reminders_days')->default(20);
    ...
    {
        Schema::dropIfExists('status_reg_pracs');
    }
};
