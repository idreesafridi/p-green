...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('status_technicians', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('tecnician_id')->nullable();
            $table->foreign('tecnician_id')->references('id')->on('users')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('status_technicians');
    }
};
