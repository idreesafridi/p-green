...
class StatusLegge10Controller extends Controller
{
     ...
     */
    public function __construct(Request $request, StatusLeg10 $modal)
    {
    ...
    /**
     * change the status status_leg10
     */
    public function status_leg10($id)
    {
        $data = $this->_request->only('state', 'reminders_emails', 'reminders_days');
        $this->change_status($this->_modal, $id, $data, 'status_leg10');
